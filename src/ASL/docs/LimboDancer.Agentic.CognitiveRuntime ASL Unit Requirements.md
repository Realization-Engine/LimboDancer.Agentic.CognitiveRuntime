...
1. **Display:** the [ASL Unit Display Design](<ASL Unit Display Design.md>), Personnel and SW first, then Guns (both built; its sections 16 and 17), then vehicles (ASL-UNIT-070 to 078). It needs neither D1 nor D2.
