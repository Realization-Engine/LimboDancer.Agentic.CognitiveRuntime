...
The [execution boundary review](<./Scenario A1 Second Defender Execution Boundary Review 2026-09-24.md>) now pins the core return/MF/MPh effects, conditional hazards and the runtime gate/store requirements. It does not introduce an executor or state mutation.
