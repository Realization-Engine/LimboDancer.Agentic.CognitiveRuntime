...
- `ASL Unit Display Design.md`: accepted design for the unit vocabulary, unit documents, style sheets, SVG rendering, the Units layer, and the Unit Lab; phases 1 (Personnel and SW) and 2 (Guns) are built, as recorded in its sections 16 and 17.
