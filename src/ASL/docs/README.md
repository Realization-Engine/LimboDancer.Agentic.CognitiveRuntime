...
- `ASL Unit LOS Slice 3 Design.md`: step 15 of the unit sequence (proposed): bridges, rowhouse and factory walls, factories, roofless buildings, rubble, bocage, hillocks, railroad embankments, and slopes in the LOS read, with oracle fixtures for boards chosen for them.
