...
- `ASL Unit LOS Result Design.md`: step 16 of the unit sequence (proposed): the hindrance breakdown, hexside locations with both aiming points, the oracle fixtures for them, and LOS from a unit on the Play page.
