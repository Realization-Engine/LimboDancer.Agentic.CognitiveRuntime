...
- `ASL Unit Display Design.md`: accepted design for the unit vocabulary, unit documents, style sheets, SVG rendering, the Units layer, and the Unit Lab; phases 1 (Personnel and SW), 2 (Guns), and 3 (vehicles) are built, as recorded in its sections 16 to 18.
