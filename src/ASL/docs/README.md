...
- `ASL Unit LOS Slice 2 Design.md`: step 14 of the unit sequence (proposed): cellars, rooftops, depressions, and cliffs in the LOS read, with oracle fixtures for boards 05, 09, 12, and 15 and a seam scenario.
