...
- `LimboDancer.Agentic.CognitiveRuntime ASL Map Model and Authoring Design.md`: proposed design for coordinates and locations, the Terrain Raster, Hex Facts, the Feature Model and its deterministic compiler, validation, the vectorizer and F3 metrics, Scenes, board composition, the canonical board package, and the consumer read API.
