...
- `SharedBoardMetadata.xml` defines 182 terrain types. Each has a numeric code, name, LOS obstacle and hindrance flags, half-level flag, inherent-terrain flag, height, LOS category, and map color.
