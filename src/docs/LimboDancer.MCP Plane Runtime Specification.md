# LimboDancer.MCP Plane Runtime Specification

**Status:** Normative implementation specification  
**Branch:** `decision-plane`  
**Source design:** `LimboDancer.MCP Plane Runtime Design.md`  
**Audience:** Runtime, MCP, ontology, diagnostics, infrastructure, and test engineers

## 1. Purpose

This specification defines the implementation contract for the LimboDancer.MCP plane runtime.
...
```text
LimboDancer.MCP.Core.Runtime
LimboDancer.MCP.Core.Actions
LimboDancer.MCP.Core.Decision
LimboDancer.MCP.Core.Diagnostics
LimboDancer.MCP.Core.Execution
LimboDancer.MCP.Core.Observations
```

If Core becomes too broad, a future `LimboDancer.MCP.Runtime.Abstractions` project MAY be introduced.
