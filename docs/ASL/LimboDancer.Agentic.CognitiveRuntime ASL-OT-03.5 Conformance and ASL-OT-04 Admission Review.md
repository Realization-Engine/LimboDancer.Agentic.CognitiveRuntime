...
| Candidate A1 fragment coverage | The representative verification sample has 14 fragments, all `unverified`; none has the eight normalized identifiers above. The committed TIR sample has no matching A1 artifacts. The new C# generated candidate inventory records ten exact fragments for the eight rules and preserves the page-49 correction and B23.922 continuation. | Exact structural fragment spans are captured. Complete PDF comparison, formal source-verification records, and visual-dependency checks remain pending. |
