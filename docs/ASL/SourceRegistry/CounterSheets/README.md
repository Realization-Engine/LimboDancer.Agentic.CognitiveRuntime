...
| File | Content |
|---|---|
| `asl-counter-sheets.scenario-a1.source-record.json` | The source record. Status: `awaiting-transcription`. |
| `scenario-a1.counter-worksheet.csv` | The worksheet: 57 rows for four counters, with no values. |
| `scenario-a1.counter-transcription.csv` | Not yet written: the worksheet with its values filled in. |
