...
![Figure from page 112](../../Rulebook_Markdown/images/eASLRB_v3_01-p112-2.png)
...
![Figure from page 112](../../Rulebook_Markdown/images/eASLRB_v3_01-p112-1.png)
...
![Figure from page 113](../../Rulebook_Markdown/images/eASLRB_v3_01-p113-9.png)

![Figure from page 113](../../Rulebook_Markdown/images/eASLRB_v3_01-p113-8.png)
...
![Figure from page 113](../../Rulebook_Markdown/images/eASLRB_v3_01-p113-2.png)

![Figure from page 113](../../Rulebook_Markdown/images/eASLRB_v3_01-p113-3.png)

## 2. SHELLHOLES

#### 2.1

**2.1** Shellholes are represented by brown splotch marks with a dark brown core. 2U6 is an example of a shellhole. Shellholes can be created to a maximum of one per hex during play by placing a shellhole counter in Open Ground, orchard, brush, or grainfield immediately after any Original KIA result during a PFPh/DFPh resolution of a Concentrated HE FFE (or aerial bomb/rocket) attack of ≥ 150mm. Such placement removes all entrenchment counters in that hex (although not necessarily their contents) even if the hex was already a shellhole hex; the in-hex terrain *[EXC: roads]* (and any Flame/Blaze already in it) is considered to no longer exist at all. Shellholes occur only IN a Depression —not at its Crest level.

![Figure from page 113](../../Rulebook_Markdown/images/eASLRB_v3_01-p113-1.png)
...
**2.3** The conditional TEM of a shellhole is +1. It applies only to Infantry who are not Manhandling a Gun/Boat and is not cumulative with any other possible TEM.
...
![Figure from page 113](../../Rulebook_Markdown/images/eASLRB_v3_01-p113-6.png)

![Figure from page 113](../../Rulebook_Markdown/images/eASLRB_v3_01-p113-5.png)

![Figure from page 113](../../Rulebook_Markdown/images/eASLRB_v3_01-p113-7.png)
...
![Figure from page 114](../../Rulebook_Markdown/images/eASLRB_v3_01-p114-6.png)
...
![Figure from page 114](../../Rulebook_Markdown/images/eASLRB_v3_01-p114-3.png)

![Figure from page 114](../../Rulebook_Markdown/images/eASLRB_v3_01-p114-2.png)
...
![Figure from page 114](../../Rulebook_Markdown/images/eASLRB_v3_01-p114-1.png)
...
**4.41** Infantry/Cavalry entering a Sunken Road hex through a non-road hexside do so at a cost of two MF. There is no cost for leaving a Sunken Road hex other than the normal penalties (10.4) for moving to higher elevation.

##### 4.42

**4.42** Vehicles may not enter or leave a Sunken Road hex except across a road hexside. All MP penalties for entering a hex containing a wreck/vehicle, or for changing a VCA across a non-road hexside, are doubled while in a Sunken Road hex. EX: It costs a CE tank 4<sup>1</sup>/2 MP to enter a wreck hex while on a Sunken Road (1 × 2 [3.42]) × 2 [4.42] + <sup>1</sup>/2 = 4<sup>1</sup>/2.
...
![Figure from page 114](../../Rulebook_Markdown/images/eASLRB_v3_01-p114-4.png)

![Figure from page 114](../../Rulebook_Markdown/images/eASLRB_v3_01-p114-5.png)
...
![Figure from page 115](../../Rulebook_Markdown/images/eASLRB_v3_01-p115-5.png)
...
![Figure from page 115](../../Rulebook_Markdown/images/eASLRB_v3_01-p115-1.png)

![Figure from page 115](../../Rulebook_Markdown/images/eASLRB_v3_01-p115-4.png)

![Figure from page 115](../../Rulebook_Markdown/images/eASLRB_v3_01-p115-2.png)

![Figure from page 115](../../Rulebook_Markdown/images/eASLRB_v3_01-p115-3.png)
...
![Figure from page 116](../../Rulebook_Markdown/images/eASLRB_v3_01-p116-1.png)
...
![Figure from page 116](../../Rulebook_Markdown/images/eASLRB_v3_01-p116-7.png)

**6.41 PONTOON:** Only pontoon bridges, which are always at water level, permit exit/entry of a bridge through a non-road hexside without Scaling, Swimming, Fording, or Boating. Infantry may enter/exit a pontoon bridge as if it were Open Ground. Units may not move beneath a pontoon bridge. Pontoon bridge <sup>5</sup>/8" counters are considered One-Lane vehicular bridges with unlimited weight capacity.

![Figure from page 116](../../Rulebook_Markdown/images/eASLRB_v3_01-p116-2.png)

**6.42 COLLAPSE:** Wooden bridges may collapse under loads \> their current weight limit. The first time the total weight of vehicles/wrecks on a wooden bridge (regardless of length) exceeds ten tons, a Bridge Collapse DR must be made. The DR is modified by +1 for every five-ton increment or fraction thereof in excess of the current bridge weight limit. If the Final Bridge Collapse DR is ≥ 12, the entire bridge Location collapses with the elimination of all counters on and beneath it. Rubble is placed as per 6.331. If the Final Bridge Collapse DR is \< 12, the bridge remains intact and its new current weight limit is the current weight just checked. This new weight limit is marked on a side record. The bridge does not have to check for collapse again until this new current weight limit is exceeded.

**6.43 WIDTH:** All MP penalties for entering a hex containing a wreck/vehicle on a road, or for changing a VCA across a non-road hexside, are doubled while on a bridge.
...
![Figure from page 116](../../Rulebook_Markdown/images/eASLRB_v3_01-p116-8.png)
...
![Figure from page 116](../../Rulebook_Markdown/images/eASLRB_v3_01-p116-3.png)
...
![Figure from page 116](../../Rulebook_Markdown/images/eASLRB_v3_01-p116-5.png)

![Figure from page 116](../../Rulebook_Markdown/images/eASLRB_v3_01-p116-4.png)
...
**7.3** Any unarmored unit in a runway hex receives a -1 TEM to all IFT fire resolved against it regardless of fire phase. This TEM is in addition to any applicable DRM for FFMO/FFNAM and is cumulative with other (including hexside) TEM. A runway hex is considered Open Ground for all Interdiction purposes (barring the presence of any Artificial Terrain).
...
![Figure from page 117](../../Rulebook_Markdown/images/eASLRB_v3_01-p117-1.png)

![Figure from page 117](../../Rulebook_Markdown/images/eASLRB_v3_01-p117-2.png)
...
![Figure from page 118](../../Rulebook_Markdown/images/eASLRB_v3_01-p118-2.png)

![Figure from page 118](../../Rulebook_Markdown/images/eASLRB_v3_01-p118-3.png)
...
![Figure from page 118](../../Rulebook_Markdown/images/eASLRB_v3_01-p118-1.png)
...
![Figure from page 119](../../Rulebook_Markdown/images/eASLRB_v3_01-p119-1.png)
...
![Figure from page 120](../../Rulebook_Markdown/images/eASLRB_v3_01-p120-1.png)
...
![Figure from page 120](../../Rulebook_Markdown/images/eASLRB_v3_01-p120-2.png)

![Figure from page 120](../../Rulebook_Markdown/images/eASLRB_v3_01-p120-3.png)
...
![Figure from page 121](../../Rulebook_Markdown/images/eASLRB_v3_01-p121-4.png)
...
![Figure from page 121](../../Rulebook_Markdown/images/eASLRB_v3_01-p121-1.png)
...
![Figure from page 121](../../Rulebook_Markdown/images/eASLRB_v3_01-p121-5.png)
...
![Figure from page 121](../../Rulebook_Markdown/images/eASLRB_v3_01-p121-6.png)
...
![Figure from page 121](../../Rulebook_Markdown/images/eASLRB_v3_01-p121-3.png)

![Figure from page 121](../../Rulebook_Markdown/images/eASLRB_v3_01-p121-2.png)
...
![Figure from page 122](../../Rulebook_Markdown/images/eASLRB_v3_01-p122-3.png)
...
![Figure from page 122](../../Rulebook_Markdown/images/eASLRB_v3_01-p122-4.png)
...
![Figure from page 122](../../Rulebook_Markdown/images/eASLRB_v3_01-p122-1.png)
...
![Figure from page 123](../../Rulebook_Markdown/images/eASLRB_v3_01-p123-2.png)
...
![Figure from page 123](../../Rulebook_Markdown/images/eASLRB_v3_01-p123-4.png)

![Figure from page 124](../../Rulebook_Markdown/images/eASLRB_v3_01-p124-5.png)

![Figure from page 124](../../Rulebook_Markdown/images/eASLRB_v3_01-p124-6.png)
...
![Figure from page 124](../../Rulebook_Markdown/images/eASLRB_v3_01-p124-4.png)
...
![Figure from page 124](../../Rulebook_Markdown/images/eASLRB_v3_01-p124-1.png)

![Figure from page 124](../../Rulebook_Markdown/images/eASLRB_v3_01-p124-7.png)
...
![Figure from page 124](../../Rulebook_Markdown/images/eASLRB_v3_01-p124-3.png)

![Figure from page 124](../../Rulebook_Markdown/images/eASLRB_v3_01-p124-2.png)
...
![Figure from page 125](../../Rulebook_Markdown/images/eASLRB_v3_01-p125-1.png)
...
![Figure from page 126](../../Rulebook_Markdown/images/eASLRB_v3_01-p126-1.png)

![Figure from page 126](../../Rulebook_Markdown/images/eASLRB_v3_01-p126-2.png)

![Figure from page 126](../../Rulebook_Markdown/images/eASLRB_v3_01-p126-3.png)
...
![Figure from page 126](../../Rulebook_Markdown/images/eASLRB_v3_01-p126-4.png)
...
![Figure from page 126](../../Rulebook_Markdown/images/eASLRB_v3_01-p126-5.png)
...
![Figure from page 127](../../Rulebook_Markdown/images/eASLRB_v3_01-p127-1.png)

![Figure from page 127](../../Rulebook_Markdown/images/eASLRB_v3_01-p127-2.png)
...
**11.433 COMMANDO:** Gurkhas, or any unit specified by SSR or DYO special purchase as Commandos are specially trained and equipped for climbing. Commandos are prevented from Climbing a cliff hexside only on a Final Falling DR of 12 and eliminated only on a Final Falling DR ≥ 13 (11.41).
...
![Figure from page 127](../../Rulebook_Markdown/images/eASLRB_v3_01-p127-8.png)

![Figure from page 127](../../Rulebook_Markdown/images/eASLRB_v3_01-p127-7.png)
...
![Figure from page 127](../../Rulebook_Markdown/images/eASLRB_v3_01-p127-5.png)

![Figure from page 127](../../Rulebook_Markdown/images/eASLRB_v3_01-p127-6.png)

![Figure from page 127](../../Rulebook_Markdown/images/eASLRB_v3_01-p127-4.png)

![Figure from page 127](../../Rulebook_Markdown/images/eASLRB_v3_01-p127-3.png)
...
![Figure from page 128](../../Rulebook_Markdown/images/eASLRB_v3_01-p128-1.png)

![Figure from page 128](../../Rulebook_Markdown/images/eASLRB_v3_01-p128-2.png)

![Figure from page 128](../../Rulebook_Markdown/images/eASLRB_v3_01-p128-3.png)

![Figure from page 128](../../Rulebook_Markdown/images/eASLRB_v3_01-p128-4.png)
...
![Figure from page 128](../../Rulebook_Markdown/images/eASLRB_v3_01-p128-6.png)

![Figure from page 128](../../Rulebook_Markdown/images/eASLRB_v3_01-p128-7.png)
...
![Figure from page 128](../../Rulebook_Markdown/images/eASLRB_v3_01-p128-5.png)
...
![Figure from page 129](../../Rulebook_Markdown/images/eASLRB_v3_01-p129-2.png)

![Figure from page 129](../../Rulebook_Markdown/images/eASLRB_v3_01-p129-1.png)
...
![Figure from page 129](../../Rulebook_Markdown/images/eASLRB_v3_01-p129-7.png)
...
![Figure from page 129](../../Rulebook_Markdown/images/eASLRB_v3_01-p129-4.png)

![Figure from page 129](../../Rulebook_Markdown/images/eASLRB_v3_01-p129-3.png)
...
![Figure from page 129](../../Rulebook_Markdown/images/eASLRB_v3_01-p129-6.png)

![Figure from page 129](../../Rulebook_Markdown/images/eASLRB_v3_01-p129-5.png)
...
![Figure from page 129](../../Rulebook_Markdown/images/eASLRB_v3_01-p129-8.png)
...
**15.4** The MF costs for entering a grain hex are 1<sup>1</sup>/2 MF for all Infantry, Cavalry, and Horse-Drawn units.
...
![Figure from page 130](../../Rulebook_Markdown/images/eASLRB_v3_01-p130-2.png)

![Figure from page 130](../../Rulebook_Markdown/images/eASLRB_v3_01-p130-1.png)
...
![Figure from page 130](../../Rulebook_Markdown/images/eASLRB_v3_01-p130-4.png)

![Figure from page 130](../../Rulebook_Markdown/images/eASLRB_v3_01-p130-3.png)
...
![Figure from page 130](../../Rulebook_Markdown/images/eASLRB_v3_01-p130-5.png)

![Figure from page 130](../../Rulebook_Markdown/images/eASLRB_v3_01-p130-6.png)

![Figure from page 130](../../Rulebook_Markdown/images/eASLRB_v3_01-p130-8.png)

![Figure from page 130](../../Rulebook_Markdown/images/eASLRB_v3_01-p130-7.png)
...
![Figure from page 131](../../Rulebook_Markdown/images/eASLRB_v3_01-p131-5.png)

![Figure from page 131](../../Rulebook_Markdown/images/eASLRB_v3_01-p131-4.png)

![Figure from page 131](../../Rulebook_Markdown/images/eASLRB_v3_01-p131-3.png)
...
![Figure from page 131](../../Rulebook_Markdown/images/eASLRB_v3_01-p131-6.png)
...
![Figure from page 131](../../Rulebook_Markdown/images/eASLRB_v3_01-p131-1.png)

![Figure from page 131](../../Rulebook_Markdown/images/eASLRB_v3_01-p131-2.png)
...
![Figure from page 132](../../Rulebook_Markdown/images/eASLRB_v3_01-p132-1.png)
...
![Figure from page 132](../../Rulebook_Markdown/images/eASLRB_v3_01-p132-2.png)
...
![Figure from page 132](../../Rulebook_Markdown/images/eASLRB_v3_01-p132-3.png)
...
![Figure from page 133](../../Rulebook_Markdown/images/eASLRB_v3_01-p133-1.png)
...
![Figure from page 133](../../Rulebook_Markdown/images/eASLRB_v3_01-p133-2.png)

##### 20.91

**20.91** Any Good Order Infantry already IN a Depression may (if capable of Advance) claim Crest status in that same hex during its APh by remaining in the same hex and placing a Crest counter beneath it, or by expending two MF in its MPh to do so. Good Order Infantry outside a Depression may claim Crest status in the Depression hex it enters along the hexside it enters by expending one less MF than the normal COT of that hex but its Crest counter must be placed so that the middle of the three hexsides it could conceivably protect is the hexside it crossed. Therefore, this option could not be used when entering a Depression via a Depression hexside. Units may begin a scenario already set up in Crest status. Infantry in Crest status are considered entrenched one level higher than the Depression against all Direct Fire attacks across any of the front three hexsides of that Depression hex (as identified by placement of the Crest counter) which are not crossed by a Depression hexside. Crest counters must be placed so that the middle of the three hexsides it could conceivably protect does not cover a hexside intersected by the Depression terrain. Once placed, a Crest counter cannot be altered until it is removed. EX: Entry of 14T3 from T2 (see the 20.92 illustration) costs two MF unless the unit claims Crest status in T3, in which case it costs only one MF.
...
![Figure from page 133](../../Rulebook_Markdown/images/eASLRB_v3_01-p133-3.png)

##### 20.93 MPh/APh

**20.93 MPh/APh:** Infantry may not move directly from one Crest status to another (even in the APh). Crest Infantry are always considered on one specific side of the Depression terrain feature as indicated by the placement of the Crest counter beneath them with the word “Crest” on the occupied side of the Depression. Crest Infantry may exit the Depression hex to a non-Depression hex along the same side of the Depression which they occupy as if they were leaving a foxhole (one MF & COT or normal APh capability). Crest Infantry moving to any other hex must first move (or advance) out of Crest status within the same hex they presently occupy as if they were entering it from an adjacent non-Depression hex. EX: In the previous diagram, it will cost two MF (shown in red) for the 4-6-7 to move out of Crest status plus another two MF to enter T4 (or another one MF to enter S4 or U4), whereas it would cost only two MF to move directly from Crest status to S3, T2, or U3. In all cases, it could be fired on in T3 without benefit of entrenchment before entering the adjacent hex and if pinned or broken in T3 would be placed IN the Depression at the end of its MPh. It would have to become CX (A4.72) to advance into T4, but could advance into the other adjacent hexes without such a penalty.

**20.94 FIRE/CC:** Crest Infantry firing at any target not within their protected Crest front must fire as Area Fire. Crest Infantry in CC are subject to a -2 DRM for all attacks against them and a +2 DRM for any attacks they make (unless the attackers had just entered the hex through a protected Crest hexside), but if they survive their initial round of CC, they must immediately drop their Crest status if held in Melee.
...
![Figure from page 134](../../Rulebook_Markdown/images/eASLRB_v3_01-p134-1.png)

![Figure from page 134](../../Rulebook_Markdown/images/eASLRB_v3_01-p134-2.png)
...
![Figure from page 134](../../Rulebook_Markdown/images/eASLRB_v3_01-p134-4.png)

![Figure from page 134](../../Rulebook_Markdown/images/eASLRB_v3_01-p134-3.png)
...
![Figure from page 134](../../Rulebook_Markdown/images/eASLRB_v3_01-p134-8.png)

![Figure from page 134](../../Rulebook_Markdown/images/eASLRB_v3_01-p134-9.png)
...
![Figure from page 134](../../Rulebook_Markdown/images/eASLRB_v3_01-p134-6.png)

![Figure from page 134](../../Rulebook_Markdown/images/eASLRB_v3_01-p134-5.png)
...
![Figure from page 134](../../Rulebook_Markdown/images/eASLRB_v3_01-p134-7.png)
...
![Figure from page 135](../../Rulebook_Markdown/images/eASLRB_v3_01-p135-1.png)
...
![Figure from page 135](../../Rulebook_Markdown/images/eASLRB_v3_01-p135-5.png)

![Figure from page 135](../../Rulebook_Markdown/images/eASLRB_v3_01-p135-6.png)
...
![Figure from page 135](../../Rulebook_Markdown/images/eASLRB_v3_01-p135-7.png)

![Figure from page 135](../../Rulebook_Markdown/images/eASLRB_v3_01-p135-8.png)
...
![Figure from page 136](../../Rulebook_Markdown/images/eASLRB_v3_01-p136-6.png)
...
![Figure from page 136](../../Rulebook_Markdown/images/eASLRB_v3_01-p136-1.png)

![Figure from page 136](../../Rulebook_Markdown/images/eASLRB_v3_01-p136-7.png)
...
![Figure from page 136](../../Rulebook_Markdown/images/eASLRB_v3_01-p136-2.png)
...
![Figure from page 136](../../Rulebook_Markdown/images/eASLRB_v3_01-p136-8.png)
...
**23.42** A multi-level building contains another vertical Location for each level of the building—each with its own normal stacking limits. No unit may occupy more than one level at once.
...
![Figure from page 136](../../Rulebook_Markdown/images/eASLRB_v3_01-p136-3.png)

![Figure from page 136](../../Rulebook_Markdown/images/eASLRB_v3_01-p136-4.png)

![Figure from page 136](../../Rulebook_Markdown/images/eASLRB_v3_01-p136-5.png)
...
![Figure from page 137](../../Rulebook_Markdown/images/eASLRB_v3_01-p137-1.png)

**23.7 SPECIAL BUILDING TYPES:** There are four rare building types with special rules pertaining only to them.

![Figure from page 137](../../Rulebook_Markdown/images/eASLRB_v3_01-p137-6.png)
...
![Figure from page 137](../../Rulebook_Markdown/images/eASLRB_v3_01-p137-2.png)
...
![Figure from page 137](../../Rulebook_Markdown/images/eASLRB_v3_01-p137-4.png)
...
![Figure from page 137](../../Rulebook_Markdown/images/eASLRB_v3_01-p137-5.png)
...
![Figure from page 137](../../Rulebook_Markdown/images/eASLRB_v3_01-p137-3.png)
...
![Figure from page 138](../../Rulebook_Markdown/images/eASLRB_v3_01-p138-7.png)

![Figure from page 138](../../Rulebook_Markdown/images/eASLRB_v3_01-p138-4.png)
...
![Figure from page 138](../../Rulebook_Markdown/images/eASLRB_v3_01-p138-1.png)

**CUTAWAY SECTIONAL VIEW**

![Figure from page 138](../../Rulebook_Markdown/images/eASLRB_v3_01-p138-3.png)
...
![Figure from page 138](../../Rulebook_Markdown/images/eASLRB_v3_01-p138-5.png)
...
![Figure from page 138](../../Rulebook_Markdown/images/eASLRB_v3_01-p138-2.png)
...
![Figure from page 138](../../Rulebook_Markdown/images/eASLRB_v3_01-p138-6.png)

EX: The most direct movement from the second level of 24U4 to the second level of V3 is via the first level of V3.

![Figure from page 139](../../Rulebook_Markdown/images/eASLRB_v3_01-p139-1.png)
...
![Figure from page 139](../../Rulebook_Markdown/images/eASLRB_v3_01-p139-2.png)
...
![Figure from page 140](../../Rulebook_Markdown/images/eASLRB_v3_01-p140-1.png)
...
![Figure from page 141](../../Rulebook_Markdown/images/eASLRB_v3_01-p141-1.png)
...
![Figure from page 141](../../Rulebook_Markdown/images/eASLRB_v3_01-p141-2.png)

![Figure from page 141](../../Rulebook_Markdown/images/eASLRB_v3_01-p141-3.png)
...
![Figure from page 141](../../Rulebook_Markdown/images/eASLRB_v3_01-p141-4.png)
...
![Figure from page 141](../../Rulebook_Markdown/images/eASLRB_v3_01-p141-5.png)
...
![Figure from page 142](../../Rulebook_Markdown/images/eASLRB_v3_01-p142-3.png)
...
![Figure from page 142](../../Rulebook_Markdown/images/eASLRB_v3_01-p142-4.png)
...
![Figure from page 142](../../Rulebook_Markdown/images/eASLRB_v3_01-p142-5.png)
...
![Figure from page 142](../../Rulebook_Markdown/images/eASLRB_v3_01-p142-6.png)
...
![Figure from page 143](../../Rulebook_Markdown/images/eASLRB_v3_01-p143-1.png)

![Figure from page 143](../../Rulebook_Markdown/images/eASLRB_v3_01-p143-2.png)
...
![Figure from page 143](../../Rulebook_Markdown/images/eASLRB_v3_01-p143-3.png)

![Figure from page 143](../../Rulebook_Markdown/images/eASLRB_v3_01-p143-4.png)
...
![Figure from page 144](../../Rulebook_Markdown/images/eASLRB_v3_01-p144-3.png)
...
![Figure from page 144](../../Rulebook_Markdown/images/eASLRB_v3_01-p144-2.png)
...
![Figure from page 144](../../Rulebook_Markdown/images/eASLRB_v3_01-p144-1.png)
...
![Figure from page 145](../../Rulebook_Markdown/images/eASLRB_v3_01-p145-2.png)
...
![Figure from page 145](../../Rulebook_Markdown/images/eASLRB_v3_01-p145-1.png)
...
![Figure from page 146](../../Rulebook_Markdown/images/eASLRB_v3_01-p146-1.png)

![Figure from page 146](../../Rulebook_Markdown/images/eASLRB_v3_01-p146-2.png)

![Figure from page 146](../../Rulebook_Markdown/images/eASLRB_v3_01-p146-3.png)
...
![Figure from page 147](../../Rulebook_Markdown/images/eASLRB_v3_01-p147-1.png)
...
![Figure from page 147](../../Rulebook_Markdown/images/eASLRB_v3_01-p147-2.png)
...
![Figure from page 148](../../Rulebook_Markdown/images/eASLRB_v3_01-p148-1.png)

![Figure from page 148](../../Rulebook_Markdown/images/eASLRB_v3_01-p148-2.png)
...
![Figure from page 148](../../Rulebook_Markdown/images/eASLRB_v3_01-p148-3.png)

![Figure from page 148](../../Rulebook_Markdown/images/eASLRB_v3_01-p148-4.png)
...
![Figure from page 148](../../Rulebook_Markdown/images/eASLRB_v3_01-p148-5.png)

![Figure from page 148](../../Rulebook_Markdown/images/eASLRB_v3_01-p148-6.png)
...
![Figure from page 149](../../Rulebook_Markdown/images/eASLRB_v3_01-p149-1.png)

![Figure from page 149](../../Rulebook_Markdown/images/eASLRB_v3_01-p149-2.png)
...
![Figure from page 149](../../Rulebook_Markdown/images/eASLRB_v3_01-p149-3.png)
...
![Figure from page 149](../../Rulebook_Markdown/images/eASLRB_v3_01-p149-4.png)
...
![Figure from page 150](../../Rulebook_Markdown/images/eASLRB_v3_01-p150-1.png)
...
![Figure from page 150](../../Rulebook_Markdown/images/eASLRB_v3_01-p150-4.png)
...
![Figure from page 150](../../Rulebook_Markdown/images/eASLRB_v3_01-p150-2.png)

![Figure from page 150](../../Rulebook_Markdown/images/eASLRB_v3_01-p150-3.png)
...
![Figure from page 151](../../Rulebook_Markdown/images/eASLRB_v3_01-p151-1.png)
...
![Figure from page 152](../../Rulebook_Markdown/images/eASLRB_v3_01-p152-2.png)
...
![Figure from page 152](../../Rulebook_Markdown/images/eASLRB_v3_01-p152-5.png)
...
![Figure from page 152](../../Rulebook_Markdown/images/eASLRB_v3_01-p152-6.png)
...
![Figure from page 152](../../Rulebook_Markdown/images/eASLRB_v3_01-p152-7.png)
...
![Figure from page 153](../../Rulebook_Markdown/images/eASLRB_v3_01-p153-1.png)
...
![Figure from page 153](../../Rulebook_Markdown/images/eASLRB_v3_01-p153-2.png)

![Figure from page 153](../../Rulebook_Markdown/images/eASLRB_v3_01-p153-4.png)
...
![Figure from page 154](../../Rulebook_Markdown/images/eASLRB_v3_01-p154-2.png)
...
![Figure from page 154](../../Rulebook_Markdown/images/eASLRB_v3_01-p154-1.png)
...
![Figure from page 154](../../Rulebook_Markdown/images/eASLRB_v3_01-p154-3.png)
...
![Figure from page 155](../../Rulebook_Markdown/images/eASLRB_v3_01-p155-1.png)
...
![Figure from page 155](../../Rulebook_Markdown/images/eASLRB_v3_01-p155-2.png)
...
![Figure from page 155](../../Rulebook_Markdown/images/eASLRB_v3_01-p155-3.png)

![Figure from page 155](../../Rulebook_Markdown/images/eASLRB_v3_01-p155-4.png)

![Figure from page 155](../../Rulebook_Markdown/images/eASLRB_v3_01-p155-7.png)
...
![Figure from page 155](../../Rulebook_Markdown/images/eASLRB_v3_01-p155-5.png)
...
![Figure from page 155](../../Rulebook_Markdown/images/eASLRB_v3_01-p155-6.png)
...
**34.31 AIR BURSTS:** Locations of a Tower that are in a woods hex are subject to Air Burst TEM only if those Locations are not higher than the topmost Level of those woods.
...
![Figure from page 156](../../Rulebook_Markdown/images/eASLRB_v3_01-p156-1.png)
...
![Figure from page 157](../../Rulebook_Markdown/images/eASLRB_v3_01-p157-2.png)
...
![Figure from page 157](../../Rulebook_Markdown/images/eASLRB_v3_01-p157-1.png)
...
![Figure from page 157](../../Rulebook_Markdown/images/eASLRB_v3_01-p157-4.png)
...
![Figure from page 157](../../Rulebook_Markdown/images/eASLRB_v3_01-p157-3.png)
...
**22.** *37. DEBRIS:* Debris represents the scattered remains of automobile, tram car, and wagon wrecks, of pipes, girders and wrecked machinery, as well as light, scattered building rubble resulting from shelling and bombing, all of which littered the interiors and lined the roads of many cities over the course of the war. This terrain was first introduced in the historical module *RED BARRICADES* as a lighter alternative to rubble. To maximize flexibility, we use 5/8" Debris counters first introduced in the historical module *FESTUNG BUDAPEST*, which also introduced the process (now incorporated into the *TWILIGHT OF THE REICH* SSRs) for generating debris (and rubble) as part of a scenario. We also include Debris-WCB (Wide City Boulevard) counters introduced in *FESTUNG BUDAPEST*.

<!-- pdf-page 160 -->

![Figure from page 160](../../Rulebook_Markdown/images/eASLRB_v3_01-p160-page.png)
...
![Figure from page 161](../../Rulebook_Markdown/images/eASLRB_v3_01-p161-page.png)
...
© <!-- pdf-page 161 --> 2024 Multi-Man Publishing, LLC
