...
See `src/ASL/docs/LimboDancer.Agentic.CognitiveRuntime ASL Reference-Domain Requirements.md` for the current ASL reference-domain requirements and acceptance scenarios. The legacy MCP-era design is preserved in `src/_Legacy/legacy-limbodancer-mcp-system-design.md`. The ontology authoring lifecycle is defined in `src/ASL/docs/LimboDancer.Agentic.CognitiveRuntime ASL Ontology Transformation Specification.md`.
